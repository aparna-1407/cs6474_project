**Note:** This is a modified version of the original MagicDance repository. The original repository can be found [here](https://github.com/Boese0601/MagicDance). The original README file can be found below. This modified repository contains added functionality to do image2image pose transfer.
